        ...
        switch (animalSpecie) {
            case CAT -> {
                Cat animal = new Cat(
                        ...
                        userInputHandler.readLineStringList("Please enter the benefits (Separated by whitespace):"),
                        userInputHandler.readLineStringList("Please enter the drawbacks (Separated by whitespace):"),
